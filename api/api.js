...
API.createNewAccount(0, 'liandev', 'Lian Dev', 'Ceará, Brazil', 'Desenvolvedor e Designer', 'https://github.com/lian-carvalho', 'liandev.png', 360);
API.createNewAccount(1, 'socialapp', 'Social App', 'Ceará, Brazil', 'Novo projeto que saiu do forno (Social App)', '', 'sociallogo.png', 160);
API.createNewAccount(2, 'barbershop', 'Barbearia', 'Ceará, Brazil', 'Novo projeto que saiu do forno (Barbearia)', 'https://barbearia-barber.vercel.app/', 'barbericon.png', 300);
